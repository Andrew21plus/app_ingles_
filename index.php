<?php
// Manejo de mensajes antes de enviar HTML
if (isset($_REQUEST['mensaje'])) {
    $alertMessage = $_REQUEST['mensaje'];
} else {
    $alertMessage = '';
}
            ...
            <div class="card-body login-card-body">
                ...
                <form method="post">
                    ...
                    <div class="centrado">
                        ...
                        <div>
                            <a href="Controlador/controlador.php?var=1" class="btn btn-primary btn-block">Create an account</a>
                        </div>
                    </div>
                </form>
            </div>
